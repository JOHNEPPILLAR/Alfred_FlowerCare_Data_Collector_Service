...
async function needswater(req, res, next) {
  ...
  try {
    const sql = 'SELECT address, identifier, sensor_label as sensorlabel, plant_name as plantname, moisture, threshold_moisture as thresholdmoisture, zone FROM vw_water_plants';
    serviceHelper.log(
      'trace',
